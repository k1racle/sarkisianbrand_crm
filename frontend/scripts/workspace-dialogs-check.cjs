...
const files=["components/AdminProductEditor.vue","components/AdminOrderDrawer.vue","components/AdminNewProduct.vue","components/UserProfileDrawer.vue","components/EcosystemAccounts.vue","components/EcosystemTrash.vue","components/EcosystemIntegrations.vue","components/BotCommandsSettings.vue","components/CrmPipelineSettings.vue","components/CrmTaskAutomation.vue","components/AdminMediaPicker.vue","components/storefront/SitePromoCodesEditor.vue","components/storefront/SiteGiftCardsEditor.vue","components/storefront/SiteCategoriesEditor.vue","pages/crm/customers.vue","pages/crm/organizations.vue","pages/crm/deals.vue","pages/crm/tasks.vue","components/workspace/SystemWorkspacePage.vue","components/workspace/SupportWorkspacePage.vue","components/workspace/ChannelsWorkspacePage.vue","components/PlatformChatDrawer.vue","components/WorkspaceToolbar.vue","components/workspace/StoreWorkspacePage.vue"];
