          ...
          <template v-else-if="profile">
            ...
            <div data-v-ui-6d8134092fd8 class="profile-content admin-dialog-body">
              ...
              <section data-v-ui-6d8134092fd8 v-else class="profile-section">
                ...
                <div data-v-ui-6d8134092fd8 class="notification-list"><label data-v-ui-6d8134092fd8><span data-v-ui-6d8134092fd8><strong data-v-ui-6d8134092fd8>Email</strong><small data-v-ui-6d8134092fd8>Заказы, задачи, обращения и системные события</small></span><input class="crm-check" data-v-ui-6d8134092fd8 v-model="notifications.email" type="checkbox" /></label><label data-v-ui-6d8134092fd8><span data-v-ui-6d8134092fd8><strong data-v-ui-6d8134092fd8>Внутри платформы</strong><small data-v-ui-6d8134092fd8>Уведомления в рабочих кабинетах</small></span><input class="crm-check" data-v-ui-6d8134092fd8 v-model="notifications.push" type="checkbox" /></label><label data-v-ui-6d8134092fd8><span data-v-ui-6d8134092fd8><strong data-v-ui-6d8134092fd8>Чат платформы</strong><small data-v-ui-6d8134092fd8>Новые сообщения и упоминания</small></span><input class="crm-check" data-v-ui-6d8134092fd8 v-model="notifications.chat" type="checkbox" /></label></div>
