      ...
      <div data-v-ui-6d8134092fd8 v-if="isOpen" class="profile-backdrop admin-dialog-backdrop" @mousedown.self="tryClose">
        <aside data-v-ui-6d8134092fd8 class="profile-drawer admin-dialog admin-dialog--drawer" role="dialog" aria-modal="true" aria-label="Профиль пользователя">
          <header data-v-ui-6d8134092fd8 class="profile-head admin-dialog-head">
            ...
            <button data-v-ui-6d8134092fd8 class="icon-button crm-button crm-button--icon" aria-label="Закрыть" :disabled="profile?.forcePasswordChange" @click="tryClose"><X data-v-ui-6d8134092fd8 :size="19" /></button>
          </header>
          ...
          <template v-else-if="profile">
            <section data-v-ui-6d8134092fd8 class="identity">
              <button data-v-ui-6d8134092fd8 class="avatar crm-button" title="Загрузить фотографию" @click="fileInput?.click()">
              ...
              <button data-v-ui-6d8134092fd8 v-if="avatarUrl" class="remove-photo crm-button" title="Удалить фотографию" @click="removeAvatar"><Trash2 data-v-ui-6d8134092fd8 :size="15" /></button>
            ...
            <nav data-v-ui-6d8134092fd8 class="profile-tabs admin-dialog-tabs">
              <button class="crm-button" data-v-ui-6d8134092fd8 :class="{ active: tab === 'profile' }" @click="tab='profile'"><UserRound data-v-ui-6d8134092fd8 :size="16" />Профиль</button>
              <button class="crm-button" data-v-ui-6d8134092fd8 :class="{ active: tab === 'security' }" @click="tab='security'"><ShieldCheck data-v-ui-6d8134092fd8 :size="16" />Безопасность</button>
              <button class="crm-button" data-v-ui-6d8134092fd8 :class="{ active: tab === 'notifications' }" @click="tab='notifications'"><Bell data-v-ui-6d8134092fd8 :size="16" />Уведомления</button>
            </nav>
            <div data-v-ui-6d8134092fd8 class="profile-content admin-dialog-body">
              <template v-if="tab === 'profile'">
                <section data-v-ui-6d8134092fd8 class="profile-section">
                  ...
                  <div data-v-ui-6d8134092fd8 class="field-grid"><label data-v-ui-6d8134092fd8><span data-v-ui-6d8134092fd8>Имя</span><input class="crm-input" data-v-ui-6d8134092fd8 v-model.trim="requested.firstName" /></label><label data-v-ui-6d8134092fd8><span data-v-ui-6d8134092fd8>Фамилия</span><input class="crm-input" data-v-ui-6d8134092fd8 v-model.trim="requested.lastName" /></label><label data-v-ui-6d8134092fd8 class="wide"><span data-v-ui-6d8134092fd8>Телефон</span><input class="crm-input" data-v-ui-6d8134092fd8 v-model.trim="requested.phone" placeholder="+7 999 000-00-00" /></label></div>
                  <button data-v-ui-6d8134092fd8 class="secondary crm-button" :disabled="saving || profile.pendingChangeRequest" @click="submitChangeRequest">Отправить запрос на изменение</button>
                </section>
                <section data-v-ui-6d8134092fd8 class="profile-section">
                  ...
                  <div data-v-ui-6d8134092fd8 class="field-grid"><label data-v-ui-6d8134092fd8><span data-v-ui-6d8134092fd8>Город</span><input class="crm-input" data-v-ui-6d8134092fd8 v-model.trim="basic.city" /></label><label data-v-ui-6d8134092fd8><span data-v-ui-6d8134092fd8>Страна</span><input class="crm-input" data-v-ui-6d8134092fd8 v-model.trim="basic.country" maxlength="2" /></label><label data-v-ui-6d8134092fd8 class="wide"><span data-v-ui-6d8134092fd8>Часовой пояс</span><select class="crm-input" data-v-ui-6d8134092fd8 v-model="basic.timezone"><option data-v-ui-6d8134092fd8 value="Europe/Moscow">Москва (UTC+3)</option><option data-v-ui-6d8134092fd8 value="Europe/Kaliningrad">Калининград (UTC+2)</option><option data-v-ui-6d8134092fd8 value="Asia/Yekaterinburg">Екатеринбург (UTC+5)</option><option data-v-ui-6d8134092fd8 value="Asia/Novosibirsk">Новосибирск (UTC+7)</option><option data-v-ui-6d8134092fd8 value="Asia/Vladivostok">Владивосток (UTC+10)</option></select></label></div>
                  <button data-v-ui-6d8134092fd8 class="primary crm-button crm-button--primary" :disabled="saving" @click="saveBasic">Сохранить настройки</button>
                </section>
              </template>
              <template v-else-if="tab === 'security'">
                <section data-v-ui-6d8134092fd8 class="profile-section">
                  ...
                  <div data-v-ui-6d8134092fd8 class="field-grid single"><label data-v-ui-6d8134092fd8><span data-v-ui-6d8134092fd8>Текущий пароль</span><input class="crm-input" data-v-ui-6d8134092fd8 v-model="passwords.currentPassword" type="password" autocomplete="current-password" /></label><label data-v-ui-6d8134092fd8><span data-v-ui-6d8134092fd8>Новый пароль</span><input class="crm-input" data-v-ui-6d8134092fd8 v-model="passwords.newPassword" type="password" autocomplete="new-password" placeholder="Не менее 10 символов, буквы и цифры" /></label><label data-v-ui-6d8134092fd8><span data-v-ui-6d8134092fd8>Повторите новый пароль</span><input class="crm-input" data-v-ui-6d8134092fd8 v-model="passwords.repeatPassword" type="password" autocomplete="new-password" /></label></div>
                  <button data-v-ui-6d8134092fd8 class="primary crm-button crm-button--primary" :disabled="saving || !passwords.currentPassword || !passwords.newPassword" @click="changePassword">Сменить пароль</button>
                </section>
                <section data-v-ui-6d8134092fd8 class="profile-section">
              ...
              <section data-v-ui-6d8134092fd8 v-else class="profile-section">
                ...
                <div data-v-ui-6d8134092fd8 class="notification-list"><label class="crm-toggle-row" data-v-ui-6d8134092fd8><span data-v-ui-6d8134092fd8><strong data-v-ui-6d8134092fd8>Email</strong><small data-v-ui-6d8134092fd8>Заказы, задачи, обращения и системные события</small></span><input class="crm-check" data-v-ui-6d8134092fd8 v-model="notifications.email" type="checkbox" /></label><label class="crm-toggle-row" data-v-ui-6d8134092fd8><span data-v-ui-6d8134092fd8><strong data-v-ui-6d8134092fd8>Внутри платформы</strong><small data-v-ui-6d8134092fd8>Уведомления в рабочих кабинетах</small></span><input class="crm-check" data-v-ui-6d8134092fd8 v-model="notifications.push" type="checkbox" /></label><label class="crm-toggle-row" data-v-ui-6d8134092fd8><span data-v-ui-6d8134092fd8><strong data-v-ui-6d8134092fd8>Чат платформы</strong><small data-v-ui-6d8134092fd8>Новые сообщения и упоминания</small></span><input class="crm-check" data-v-ui-6d8134092fd8 v-model="notifications.chat" type="checkbox" /></label></div>
                <button data-v-ui-6d8134092fd8 class="primary crm-button crm-button--primary" :disabled="saving" @click="saveNotifications">Сохранить уведомления</button>
              </section>
            </div>
          </template>
