...
<template>
  <section class="sb-gift-admin" aria-label="Управление подарочными картами">
    ...
    <form v-if="tab === 'product' && product && !loading" class="sb-gift-product-form" novalidate @submit.prevent="saveProduct">
      <section class="sb-gift-panel sb-gift-form sb-gift-product-block" aria-label="Настройки товара подарочной карты">
      ...
      <section class="sb-gift-panel sb-gift-form sb-gift-denomination-block" aria-label="Номиналы подарочной карты"><fieldset :disabled="busy" class="sb-gift-fields">
