    ...
    <template v-else>
      <header data-v-ui-9c61dc015e2a class="page-head">
        <div data-v-ui-9c61dc015e2a>
          ...
          <h1 data-v-ui-9c61dc015e2a>Обзор команды</h1>
          <span data-v-ui-9c61dc015e2a>Сделки, клиенты, задачи и коммуникации в одном рабочем пространстве</span>
        </div>
        <div data-v-ui-9c61dc015e2a class="head-actions">
          ...
          <NuxtLink data-v-ui-9c61dc015e2a to="/crm-tasks?create=1" class="light"><ClipboardList data-v-ui-9c61dc015e2a :size="16" />Новая задача</NuxtLink>
          <NuxtLink data-v-ui-9c61dc015e2a to="/crm-pipeline?create=1"><Plus data-v-ui-9c61dc015e2a :size="16" />Новая сделка</NuxtLink>
        </div>
      </header>
      ...
      <template v-else-if="dashboard">
        <section data-v-ui-9c61dc015e2a class="kpis">
          ...
          <article data-v-ui-9c61dc015e2a>
            <i data-v-ui-9c61dc015e2a><Users data-v-ui-9c61dc015e2a :size="18" /></i><span data-v-ui-9c61dc015e2a>Открытые сделки</span>
          ...
          <article data-v-ui-9c61dc015e2a :class="{ danger: dashboard.overdueTasks }">
        ...
        <section data-v-ui-9c61dc015e2a class="dashboard-grid">
          <article data-v-ui-9c61dc015e2a class="panel funnel-panel">
            <header data-v-ui-9c61dc015e2a>
              ...
              <NuxtLink data-v-ui-9c61dc015e2a to="/crm-pipeline">Открыть воронку <ArrowRight data-v-ui-9c61dc015e2a :size="14" /></NuxtLink>
            </header>
            <div data-v-ui-9c61dc015e2a class="funnel">
              <button data-v-ui-9c61dc015e2a v-for="stage in dashboard.funnel" :key="stage.id" @click="navigateTo('/crm-pipeline')">
          ...
          <article data-v-ui-9c61dc015e2a class="panel tasks-panel">
            <header data-v-ui-9c61dc015e2a>
              <div data-v-ui-9c61dc015e2a><p data-v-ui-9c61dc015e2a>ФОКУС</p><h2 data-v-ui-9c61dc015e2a>Ближайшие задачи</h2></div>
            ...
            <div data-v-ui-9c61dc015e2a v-if="urgentTasks.length" class="task-list">
              <button data-v-ui-9c61dc015e2a v-for="task in urgentTasks" :key="task.id" @click="navigateTo('/crm-tasks')">
                <span data-v-ui-9c61dc015e2a class="task-check" :class="task.status.toLowerCase()"><CheckCircle2 data-v-ui-9c61dc015e2a :size="15" /></span>
          ...
          <article data-v-ui-9c61dc015e2a class="panel activity-panel">
            ...
            <div data-v-ui-9c61dc015e2a v-if="dashboard.recentInteractions?.length" class="activity-list">
              <button data-v-ui-9c61dc015e2a v-for="item in dashboard.recentInteractions" :key="item.id" @click="navigateTo('/crm-pipeline')">
          ...
          <article data-v-ui-9c61dc015e2a class="panel quick-panel">
            ...
            <div data-v-ui-9c61dc015e2a class="quick-grid">
              <NuxtLink data-v-ui-9c61dc015e2a to="/crm-pipeline"><Target data-v-ui-9c61dc015e2a :size="20" /><span data-v-ui-9c61dc015e2a><b data-v-ui-9c61dc015e2a>Воронка продаж</b><small data-v-ui-9c61dc015e2a>Сделки и прогноз</small></span><ArrowRight data-v-ui-9c61dc015e2a :size="15" /></NuxtLink>
              <NuxtLink data-v-ui-9c61dc015e2a to="/crm-customers"><Users data-v-ui-9c61dc015e2a :size="20" /><span data-v-ui-9c61dc015e2a><b data-v-ui-9c61dc015e2a>Клиенты 360°</b><small data-v-ui-9c61dc015e2a>История и заказы</small></span><ArrowRight data-v-ui-9c61dc015e2a :size="15" /></NuxtLink>
              <NuxtLink data-v-ui-9c61dc015e2a to="/crm-tasks"><ClipboardList data-v-ui-9c61dc015e2a :size="20" /><span data-v-ui-9c61dc015e2a><b data-v-ui-9c61dc015e2a>Задачи</b><small data-v-ui-9c61dc015e2a>Канбан, Гант, календарь</small></span><ArrowRight data-v-ui-9c61dc015e2a :size="15" /></NuxtLink>
            </div>
          </article>
        </section>
      </template>
