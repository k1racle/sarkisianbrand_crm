...
<template>
  <main data-v-ui-765289f0fbc4 class="customer-page">
    <header data-v-ui-765289f0fbc4 class="page-header"><div data-v-ui-765289f0fbc4><p data-v-ui-765289f0fbc4>CRM / CUSTOMER 360</p><h1 data-v-ui-765289f0fbc4>Клиенты</h1><span data-v-ui-765289f0fbc4>Единая история B2C и B2B: покупки, лиды, обращения и компании</span></div><button data-v-ui-765289f0fbc4 @click="load"><RefreshCw data-v-ui-765289f0fbc4 :size="16" :class="{ spin: loading }" /> Обновить</button></header>
    ...
    <div data-v-ui-765289f0fbc4 v-else-if="dashboard" class="page-body">
      <section data-v-ui-765289f0fbc4 class="kpis">
        <article data-v-ui-765289f0fbc4><UserRound data-v-ui-765289f0fbc4 :size="18" /><span data-v-ui-765289f0fbc4>Всего клиентов</span><strong data-v-ui-765289f0fbc4>{{ dashboard?.customers || 0 }}</strong><small data-v-ui-765289f0fbc4>{{ dashboard?.newCustomers || 0 }} новых за 30 дней</small></article>
        <article data-v-ui-765289f0fbc4><Users data-v-ui-765289f0fbc4 :size="18" /><span data-v-ui-765289f0fbc4>Активные</span><strong data-v-ui-765289f0fbc4>{{ dashboard?.active || 0 }}</strong><small data-v-ui-765289f0fbc4>доступны для работы</small></article>
        <article data-v-ui-765289f0fbc4><ShoppingBag data-v-ui-765289f0fbc4 :size="18" /><span data-v-ui-765289f0fbc4>Розничные B2C</span><strong data-v-ui-765289f0fbc4>{{ dashboard?.b2cCustomers || 0 }}</strong><small data-v-ui-765289f0fbc4>покупатели магазина</small></article>
        <article data-v-ui-765289f0fbc4><Building2 data-v-ui-765289f0fbc4 :size="18" /><span data-v-ui-765289f0fbc4>Клиенты B2B</span><strong data-v-ui-765289f0fbc4>{{ dashboard?.b2bCustomers || 0 }}</strong><small data-v-ui-765289f0fbc4>{{ dashboard?.organizations || 0 }} организаций</small></article>
      </section>
      <section data-v-ui-765289f0fbc4 class="panel">
        <div data-v-ui-765289f0fbc4 class="filters"><label data-v-ui-765289f0fbc4><Search data-v-ui-765289f0fbc4 :size="16" /><input data-v-ui-765289f0fbc4 v-model="search" placeholder="Имя, email, телефон или организация" /></label><select data-v-ui-765289f0fbc4 v-model="segment"><option data-v-ui-765289f0fbc4 value="">Все сегменты</option><option data-v-ui-765289f0fbc4 value="B2C">B2C</option><option data-v-ui-765289f0fbc4 value="B2B">B2B</option><option data-v-ui-765289f0fbc4 value="Лид">Лиды</option></select><select data-v-ui-765289f0fbc4 v-model="status"><option data-v-ui-765289f0fbc4 value="">Все статусы</option><option data-v-ui-765289f0fbc4 value="ACTIVE">Активные</option><option data-v-ui-765289f0fbc4 value="BLOCKED">Заблокированные</option><option data-v-ui-765289f0fbc4 value="ARCHIVED">Архив</option></select></div>
        <div data-v-ui-765289f0fbc4 class="customer-row head"><span data-v-ui-765289f0fbc4>Клиент</span><span data-v-ui-765289f0fbc4>Контакты</span><span data-v-ui-765289f0fbc4>Сегмент</span><span data-v-ui-765289f0fbc4>Связи</span><span data-v-ui-765289f0fbc4>Активность</span></div>
        <button data-v-ui-765289f0fbc4 v-for="customer in customers" :key="customer.id" class="customer-row" @click="openCustomer(customer)" @contextmenu.prevent="customerMenu($event,customer)"><span data-v-ui-765289f0fbc4 class="identity"><i data-v-ui-765289f0fbc4>{{ (customer.firstName || customer.email || 'К').slice(0, 1).toUpperCase() }}</i><span data-v-ui-765289f0fbc4><strong data-v-ui-765289f0fbc4>{{ [customer.firstName, customer.lastName].filter(Boolean).join(' ') || 'Без имени' }}</strong><small data-v-ui-765289f0fbc4>{{ statusLabels[customer.status] }}</small></span></span><span data-v-ui-765289f0fbc4 class="contacts"><b data-v-ui-765289f0fbc4>{{ customer.email || 'Email не указан' }}</b><small data-v-ui-765289f0fbc4>{{ customer.phone || 'Телефон не указан' }}</small></span><span data-v-ui-765289f0fbc4><em data-v-ui-765289f0fbc4>{{ customer.segment || 'Не определён' }}</em></span><span data-v-ui-765289f0fbc4 class="counts"><b data-v-ui-765289f0fbc4>{{ customer._count.orders }} заказов</b><small data-v-ui-765289f0fbc4>{{ customer.organizationMemberships[0]?.organization?.name || `${customer._count.leads} лидов` }}</small></span><span data-v-ui-765289f0fbc4 class="counts"><b data-v-ui-765289f0fbc4>{{ customer._count.helpdeskTickets }} заявок</b><small data-v-ui-765289f0fbc4>{{ customer._count.interactions }} контактов</small></span></button>
        <p data-v-ui-765289f0fbc4 v-if="!customers.length" class="empty">По заданным условиям клиентов нет</p>
      </section>
    </div>

    <aside data-v-ui-765289f0fbc4 v-if="selected" class="backdrop admin-dialog-backdrop" @click.self="closeEditor"><div data-v-ui-765289f0fbc4 ref="entityPanel" class="drawer admin-dialog admin-dialog--drawer" role="dialog" aria-modal="true" tabindex="-1" @keydown="entityKeys"><header data-v-ui-765289f0fbc4><div data-v-ui-765289f0fbc4><p data-v-ui-765289f0fbc4>CUSTOMER 360</p><h2 data-v-ui-765289f0fbc4>{{ [selected.firstName, selected.lastName].filter(Boolean).join(' ') || 'Карточка клиента' }}</h2><span data-v-ui-765289f0fbc4>{{ selected.email || selected.phone || 'Контакты не указаны' }}</span></div><button data-v-ui-765289f0fbc4 @click="closeEditor" :disabled="actionBusy" aria-label="Закрыть карточку"><X data-v-ui-765289f0fbc4 :size="19" /></button></header><div data-v-ui-765289f0fbc4 class="drawer-body admin-dialog-body"><p data-v-ui-765289f0fbc4 v-if="error" class="operation-error" role="alert">{{ error }}</p>
      <fieldset data-v-ui-765289f0fbc4 class="edit-grid ui-fieldset-reset" :disabled="actionBusy || !canEdit"><label data-v-ui-765289f0fbc4>Имя<input data-v-ui-765289f0fbc4 v-model="selected.firstName" /></label><label data-v-ui-765289f0fbc4>Фамилия<input data-v-ui-765289f0fbc4 v-model="selected.lastName" /></label><label data-v-ui-765289f0fbc4>Телефон<input data-v-ui-765289f0fbc4 v-model="selected.phone" /></label><label data-v-ui-765289f0fbc4>Сегмент<input data-v-ui-765289f0fbc4 v-model="selected.segment" /></label><label data-v-ui-765289f0fbc4>Статус<select data-v-ui-765289f0fbc4 v-model="selected.status"><option data-v-ui-765289f0fbc4 value="ACTIVE">Активен</option><option data-v-ui-765289f0fbc4 value="BLOCKED">Заблокирован</option><option data-v-ui-765289f0fbc4 value="ARCHIVED">В архиве</option></select></label><button data-v-ui-765289f0fbc4 @click="saveCustomer" :disabled="actionBusy || !canEdit">Сохранить карточку</button></fieldset>
